...
public class EnemyShoot extends Enemy {
	...
	public void projectileOperation(Panel panel,ArrayList<Player> listPlayer,ArrayList<Entity> entities, int width,int height, Player player) {
...
//		setvRecoil(10);
	...
	public void step(Window window,ArrayList<Player> listPlayer,ArrayList<Obstacle> obstacles,ArrayList<Entity> entities) {
		...
		projectileOperation(window.panel, listPlayer, entities, window.getWidth(), window.getHeight(), listPlayer.get(0));
