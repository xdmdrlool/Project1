...
//				System.out.println(portal1.getHitbox().getForm().getAngle());
					...
					if (player.getHitbox().colision(portal1.getHitbox())) {
						double distancePlayerPortal1=Math.sqrt((player.getX()-xAPortal1)*(player.getX()-xAPortal1)+(player.getY()-yAPortal1)*(player.getY()-yAPortal1));
						...
						player.moveIn((int) (xAPortal2+vectorABPortal2[0]*distancePlayerPortal2),(int) (yAPortal2+vectorABPortal2[1]*distancePlayerPortal2));
					}
						...
						player.moveIn((int) (xAPortal1+vectorABPortal1[0]*distancePlayerPortal1),(int) (yAPortal1+vectorABPortal1[1]*distancePlayerPortal1));
					}
				}
