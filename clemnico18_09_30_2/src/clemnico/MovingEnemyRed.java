...
public class MovingEnemyRed extends Enemy {
////Attributs////
	private String 	name = "" ;
	...
	////Constructeur////
	public MovingEnemyRed(int x,int y,int width, int height, int radius,String name, int direction, int speed, boolean move) {
		super(x,y);
...
//				System.out.println(vecteurCorrection.x+" "+vecteurCorrection.y);
				...
				if (directionCollision.y>0 && (x<obstacle.getX() || x+width>obstacle.getX()+obstacle.getWidth())) {setVx(-vx);};
