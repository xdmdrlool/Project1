...
public class MovingEnemyGreen extends Enemy {
////Attributs////
	private String 	name = "" ;
	...
	////Constructeur////
	public MovingEnemyGreen(int x,int y,int width, int height, int radius,String name, int direction, int speed, boolean move) {
		super(x,y);
...
//				System.out.println(vecteurCorrection.x+" "+vecteurCorrection.y);
				...
				if (directionCollision.x!=0) {setVx(-vx);}
...
//				System.out.println("x :"+x+"   y : "+y+"     vy : "+vy+"     "+varInTheAir);
	...
	public void setInTheAir(boolean inTheAir) {
		if (this.inTheAir != inTheAir) {
			 setTimeInAir(0);
//			 if (inTheAir) { setCurrentAnimation(NameAnimation.JUMP);}
//			 else {setCurrentAnimation(NameAnimation.DEFAULT);}
